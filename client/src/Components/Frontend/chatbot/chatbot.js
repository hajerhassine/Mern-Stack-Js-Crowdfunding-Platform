  ...
  handleSend =()=>{
    ...
    if(this.state.message==""){
           ...
           .then(res=>{
               ...
               ch.push({from:'Lancini',message:res.data.answer})
    ...
    return (
       ...
       <div id="cb">
        ...
        <div class="card-header">
                        ...
                        <h6 class="card-title"><p>Chat With Lancini</p></h6> 
                    </div>
            ...
            <nav class="navbarr bg-white navbar-expand-sm d-flex justify-content-between"> <input type="text"   name="message" onChange={(e)=>this.handleChange(e)} value={this.state.message}  class="form-control" placeholder="Type a message..."/>
