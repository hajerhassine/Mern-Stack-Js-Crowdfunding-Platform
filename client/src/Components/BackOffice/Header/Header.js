  ...
  <nav className="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul className="navbar-nav navbar-right">
            ...
            <div className="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div className="dropdown-list-content dropdown-list-message">
                <a href="#" className="dropdown-item"> <span className="dropdown-item-avatar
											text-white"> <img alt="image" src="assets2/img/users/user-1.png" className="rounded-circle"/>
                    ...
                    <img alt="image" src="assets2/img/users/user-2.png" className="rounded-circle"/>
                    ...
                    <img alt="image" src="assets2/img/users/user-5.png" className="rounded-circle"/>
                    ...
                    <img alt="image" src="assets2/img/users/user-4.png" className="rounded-circle"/>
                    ...
                    <img alt="image" src="assets2/img/users/user-3.png" className="rounded-circle"/>
              ...
              <div className="dropdown-list-content dropdown-list-icons">
                <a href="#" className="dropdown-item dropdown-item-unread"> <span
                    ...
                    clean it! <span className="time">17 Hours Ago</span>
												...
												fa-bell"></i>
                  </span> <span className="dropdown-item-desc"> Welcome to Lancini
          ...
          <li className="dropdown"><a href="#" data-toggle="dropdown"
              className="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="assets2/img/user.png"
