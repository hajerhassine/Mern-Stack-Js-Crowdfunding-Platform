...
const bankingpartners = require( '../models/bankingpartners.js');
 ...
 const createBankingPartners = async (req, res) => {
    const { bank_name, description ,offer , email , image } = req.body;
 
    const newbankingpartner = new bankingpartners({ bank_name, description  , offer , email,  image})
 ...
 const updateBankingPartners = async (req, res) => {
    ...
    const updateBankingPartners = { bank_name, description  , offer , email , image, _id: id };
